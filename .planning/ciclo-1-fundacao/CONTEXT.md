...
> **Nota posterior (26/07/2026):** o nó foi renomeado para `homelab` e a URL vigente passou a ser `https://homelab.tailb4f665.ts.net`. O registro acima é histórico do Ciclo 1 e foi preservado como tal. Ver `.planning/_archive/rename-node-homelab/plan.md` (arquivado em 12/09/2026 pela TECH-220).
