...
Para ativar o stack Python (tooling), use: `.agents/stacks/python/README.md`.
...
```bash
cp .agents/stacks/python/pyproject.toml ./pyproject.toml
cp .agents/stacks/python/requirements-dev.txt ./requirements-dev.txt
cp .agents/stacks/python/.pre-commit-config.yaml ./.pre-commit-config.yaml
...
- `.agents/stacks/python/pyproject.toml`
- `.agents/stacks/python/requirements-dev.txt`
- `.agents/stacks/python/.pre-commit-config.yaml`
