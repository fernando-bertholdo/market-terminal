...
| 2026-09-14 | `c3458f1` | — | `init-detour`, `reconcile-initiative`, `validate-dor`, `validate-dod`, `fresh-context`, `generate-tap` | Propagação do tech-product-template 2.13.0 → 2.14.0: TECH-574 troca a dívida de saída do detour (linha de delta no `Roadmap.md`) pela pergunta de entrada gravada no `CONTEXT.md`, e o índice do detour passa a viver só no `.planning/README.md`; TECH-552 neutraliza o jargão vazado nos exemplos, preservando a tradução descendente já feita neste repositório |
