...
| 2026-03-30 | `5b9eae4` | SYNC-20260330-003/004/005 | 5 UI skills, `README.md` | Propaga UI Excellence para .codex/.agents; propagado para lass (6a1e474) e monitor-fundos (94ff40d) |
...
| 2026-04-10 | `PENDING` | SYNC-20260410-001 | 8 UI skills novas + 5 refreshed, `sync-downstream/SKILL.md`, `README.md` | Skills UI sincronizadas do marketplace `4-successful-ai-life`; 13 skills via sync-ui-from-marketplace.sh; sync-downstream v1.3.0 |
...
| 2026-09-14 | `7fe1a56` | SYNC-20260914-002 | `init-detour/SKILL.md`, `reconcile-initiative/SKILL.md` | TECH-574: a dívida de saída do detour vira pergunta de entrada. `init-detour` pergunta "o que este trabalho muda no plano?" e grava a resposta no CONTEXT.md; `reconcile-initiative` confronta a resposta com o entregue na dimensão 4a.1. Sai o gate `grep <ID> documents/core/Roadmap.md` — medição na origem: 66 detours na linhagem, zero linhas de delta cumpridas. Traz junto o `--parent-issue` da SYNC-20260912-001, que não havia chegado a este derivado. Sync-ID gerado aqui: a entrada correspondente na origem está sem Sync-ID |
| 2026-09-14 | `6eecc3e` | SYNC-20260914-003 | `validate-dor/SKILL.md`, `validate-dod/SKILL.md`, `fresh-context/SKILL.md`, `generate-tap/SKILL.md` | TECH-552: neutraliza o jargão do projeto de origem que vazou nos exemplos das quatro skills. O `AGENTS.md` da raiz ganha a tabela de destinos que só existia no `CLAUDE.md`, espelhada da seção local — não da origem, que aqui diverge por adaptação declarada. Sync-ID gerado aqui: a entrada correspondente na origem está sem Sync-ID |
