...
a) Agrupar bullets por seção do TAP template
   (usar .claude/prompts/tap-template.md como referência)
...
```
a) Usar template de .claude/prompts/tap-template.md como estrutura
...
c) Reportar ao usuário:
   ...
   **Conflitos detectados:** [lista, se houver]
   ...
   3. Executar kickoff: usar .claude/prompts/kickoff-prompt.md
...
**Arquivo gerado:** documents/archive/TAP_market-terminal.md
